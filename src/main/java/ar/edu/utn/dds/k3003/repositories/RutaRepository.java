...
public class RutaRepository {
  ...
  public List<Ruta> findByHeladeras(Integer heladeraOrigen, Integer heladeraDestino) throws TrasladoNoAsignableException {

    List<Ruta> posiblesRutas = this.rutas.stream().filter(x -> x.getHeladeraIdOrigen().equals(heladeraOrigen) &&
